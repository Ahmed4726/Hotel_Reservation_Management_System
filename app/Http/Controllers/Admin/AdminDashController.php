...
class AdminDashController extends Controller
{
    public function index(){
     ...
     $total_subcribers=Subcriber::where('status',1)->count();
     $orders=Order::orderBy('id','desc')->skip(0)->take(5)->get();
     
     
     return view('admin.adminH',compact('total_completed_orders','total_pending_orders','total_active_customers','total_pending_customers','total_rooms','total_subcribers','orders'));
