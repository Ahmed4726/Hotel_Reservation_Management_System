            ...
            <div class="col-lg-8 col-md-6 checkout-left">
                ...
                @csrf
                    <div class="billing-info">
                        ...
                        if(session()->has('billing_postcode')){

                           $billing_postcode=session()->get('billing_postcode');
                        }else{

                            $billing_postcode=Auth::guard('customer')->user()->postcode;
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control mb_15" name="billing_postcode" value="{{ $billing_postcode }}">
                            </div>
                        </div>
                    </div>
