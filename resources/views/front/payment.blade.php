        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 checkout-left mb_30">
                ...
                <div class="stripe mt_20">
                    ...
                    $stripe_publishable_key='pk_test_51OH8HsK6QZt5WOOQigw6FFYbgbvO6Ai7tqX7eeaNnVdCqU6IvrLhBXSMFGNyDChvBjJM84VKJnMcn4dvfRJGR0WD00vaYwy6sR';
                    @endphp
            ...
            <div class="col-lg-4 col-md-4 checkout-right">
                <div class="inner">
                  ...
                  <div>
                        ...
                        Postcode: {{ session()->get('billing_postcode') }}
                    ...
                    <div class="table-responsive">
                        ...
                        for($i=0;$i<count($arr_cart_room_id);$i++){
                            ...
                            @endphp
                                ...
                                <tr>
                                    <td><b>Total:</b></td>
                                    <td class="p_price"><b>MYR{{ $total_price }}</b></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
