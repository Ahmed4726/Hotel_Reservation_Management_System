<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ route('customer_dash') }}">My Panel</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ route('customer_dash') }}"></a>
        </div>

        <ul class="sidebar-menu">

            <li class="{{ Request::is('customer/dash') ? 'active' : ''}}"><a class="nav-link" href="{{ route('customer_dash') }}"><i class="fa fa-hand-o-right"></i> <span>Dashboard</span></a></li>
           ...
           {{-- <liclass="nav-itemdropdownRequest::is('admin/amenity/view')||Request::is('admin/room/view')?'active':'' ">
           ...
           {{-- <liclass="Request::is('admin/faq/*')?'active':'' "><a class="nav-link" href="{{ route('admin_faq_view') }}"><i class="fa fa-hand-o-right"></i> <span>FAQ</span></a></li> --}}
