...
class AdminRoomController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $request->validate(['featured_photo'=>'required|image|mimes:jpg,jpeg,png,gif',
                            'name'=>'required',
    ...
    public function delete($id){
        ...
        return redirect()->back()->with('success','Room is delete successfully');
    }
    ...
    public function gallery_store(Request $request,$id){
        ...
        $request->validate(['photo'=>'required|image|mimes:jpg,jpeg,png,gif'
    ...
    public function gallery_delete($id){
        ...
        return redirect()->back()->with('success','Photo is delete successfully');
    }
