<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ route('admin_dash') }}">Admin Panel</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ route('admin_dash') }}"></a>
        </div>

        <ul class="sidebar-menu">

            <li class="{{ Request::is('admin/dash') ? 'active' : ''}}"><a class="nav-link" href="{{ route('admin_dash') }}"><i class="fa fa-hand-o-right"></i> <span>Dashboard</span></a></li>

            <li class="nav-item dropdown {{ Request::is('admin/page/about') ||Request::is('admin/page/terms') ||Request::is('admin/page/privacy') ||Request::is('admin/page/contact') ||Request::is('admin/page/cart') ||Request::is('admin/page/checkout') ||Request::is('admin/page/payment') ||Request::is('admin/page/signup') ||Request::is('admin/page/signin')||Request::is('admin/page/forget_password')||Request::is('admin/page/reset_password') ? 'active' : ''}} ">
               ...
               <ul class="dropdown-menu">
                   ...
                   <li class="{{ Request::is('admin/page/terms') ? 'active' : ''}} "><a class="nav-link" href="{{ route('admin_page_terms') }}"><i class="fa fa-angle-right"></i> Terms and Condition </a></li>
                   ...
                   <li class="{{ Request::is('admin/page/forget_password') ? 'active' : ''}} "><a class="nav-link" href="{{ route('admin_page_forget_password') }}"><i class="fa fa-angle-right"></i> Forget Password </a></li>

                   <li class="{{ Request::is('admin/page/reset_password') ? 'active' : ''}} "><a class="nav-link" href="{{ route('admin_page_reset_password') }}"><i class="fa fa-angle-right"></i> Reset Password </a></li>
            ...
            <li class="{{ Request::is('admin/orders/*') ? 'active' : ''}}"><a class="nav-link" href="{{ route('admin_orders') }}"><i class="fa fa-hand-o-right"></i> <span>Orders</span></a></li>
            ...
            <li class="nav-item dropdown {{ Request::is('admin/subcriber/show') ||Request::is('admin/subcriber/send_email') ? 'active' : ''}} ">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-hand-o-right"></i><span>Subscribers</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('admin/subcriber/show') ? 'active' : ''}} "><a class="nav-link" href="{{ route('admin_subcriber_show') }}"><i class="fa fa-angle-right"></i> All Subscribers </a></li>

                    <li class="{{ Request::is('admin/subcriber/send_email') ? 'active' : ''}} "><a class="nav-link" href="{{ route('admin_subcriber_send_email') }}"><i class="fa fa-angle-right"></i> Send Email </a></li>
