...
class CustomerAuthController extends Controller
{
 ...
 public function signup_submit(Request $request){
  ...
  $request->validate([
   ...
   $message='Please click on the link below to confirm the sign up process: <br>';
 ...
 public function signup_verify($email,$token){
  ...
  if($customer_data){
    ...
    return redirect()->route('customer_login')->with('success','Your account verified successfully');
  ...
  public function forget_password_submit(Request $request){
    ...
    Mail::to($request->email)->send(new Websitemail($subject,$message));
    return redirect()->route('customer_login')->with('success','Please check your mail');
  }
  ...
  public function reset_password_submit(Request $request){
    ...
    $request->validate(['password'=>'required','retype_password'=>'required|same:password']);
