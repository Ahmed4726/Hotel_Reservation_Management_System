...
class BookingController extends Controller
{
    public function cart_submit(Request $request){
        ...
        $request->validate([
            ...
            return redirect()->back()->with('success','Room added to the cart successfully');
    }
    ...
    public function cart_delete($id){
         ...
         public function checkout(){
            ...
            if(!Auth::guard('customer')->check()){
                 ...
                 return redirect()->back()->with('error','You must login in order to checkout');
            }
            ...
            if(!session()->has('cart_room_id')){
                 ...
                 return redirect()->back()->with('error','There is no items in the cart');
          }
         ...
         public function payment(Request $request ){
              ...
              $request->validate([
                ...
                'billing_postcode'=>'required'
                 ...
                 session()->put('billing_postcode',$request->billing_postcode);
         ...
         public function paypal($final_price){
            ...
            $client='Aa8ixeF4OZjNTI4ZVC8OpqKDRry8R0xZonHZwbMzhVHVAcN7aunraEEl9MuhgvCfl4S5Z_cK6YQo8Byi';
            $secret='EKSi39RETNfmHEjh5qiEZZnsAJHKSpuBJTVu5Xw9rDxsC-WfaCp43m_wO5o_5NPwcBII7oflcAyrc64n';
           ...
           if($result->state == 'approved')
           {
               ...
               $message .='<br>Paid Amount: MYR'.$paid_amount;
               ...
               for($i=0;$i<count($arr_cart_room_id);$i++){
                  ...
                  $message .='<br>Booking Name: '.$r_info->name;
                  $message .='<br>Price Per Night: MYR'.$r_info->price;
               ...
               Mail::to($customer_email)->send(new Websitemail($subject,$message));
                 ...
                 session()->forget('billing_postcode');
                 session()->forget('billing_country');


               
               return redirect()->route('dash')->with('success','Payment is successful');
               
           }

           else{

              return redirect()->route('dash')->with('error','Payment is failed');
           }
         ...
         public function stripe(Request $request,$final_price){
            ...
            $stripe_secret_key='sk_test_51OH8HsK6QZt5WOOQrhaMB5o1d6CdO4aHEelYzlUszAl3Uh3fzwNi7pGl3sgTN4V73T652OqALOD06sEaie7eFCqn00VojZxTJt';
            ...
            $message .='<br>Paid Amount: MYR'.$final_price;
            $message .='<br>Booking Date: '.date('d/m/Y').'<br>';
         ...
         public function check_room_availablity(Request $request)
         {
             ...
             $rooms = Room::where('total_guests', '>=', $adults + $children)
               //   ->limit(4) // Assuming you want to show only 4 available rooms
                 ...
                 if (request()->ajax()) {
                  return view('front.room_partial', compact('rooms'))->render();
              }
