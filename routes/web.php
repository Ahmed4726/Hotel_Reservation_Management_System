...
use App\Http\Controllers\Front\SubcriberController;
...
Route::post('/subcriber/send-email',[SubcriberController::class,'send_email'])->name('subcriber_send_email');
Route::get('/subcriber/verify/{email}/{token}',[SubcriberController::class,'verify'])->name('subcriber_verify');
...
Route::GET('/booking/room',[BookingController::class,'check_room_availablity'])->name('check_room_availablity');
...
Route::get('/admin/forgetPassword',[AdminLoginController::class,'forgetPassword'])->name('adminForgetPassword');
Route::post('/admin/admin-forget-password-submit',[AdminLoginController::class,'forget_password_submit'])->name('admin_forget_password_submit');
...
Route::get('/forgetPassword',[CustomerAuthController::class,'forgetPassword'])->name('customerForgetPassword');
...
Route::group(['middleware'=>['customer:customer']],function(){
    ...
    Route::get('/customer/dash',[CustomerHomeController::class,'index'])->name('customer_dash');

    Route::get('/customer/edit-profile',[CustomerProfileController::class,'index'])->name('customer_profile');
    Route::post('/customer/admin-profile-submit',[CustomerProfileController::class,'profile_submit'])->name('customer_profile_submit');
...
Route::group(['middleware'=>['admin:admin']],function(){
    ...
    Route::post('/admin/admin-profile-submit',[AdminProfileController::class,'profile_submit'])->name('admin_profile_submit');

    Route::get('/admin/dash',[AdminDashController::class,'index'])->name('admin_dash');
    ...
    Route::get('/admin/subcriber/show',[AdminSubcriberController::class,'show'])->name('admin_subcriber_show');
    Route::get('/admin/subcriber/send_email',[AdminSubcriberController::class,'send_email'])->name('admin_subcriber_send_email');
    Route::post('/admin/subcriber/send_email_submit',[AdminSubcriberController::class,'send_email_submit'])->name('admin_subcriber_send_email_submit');
